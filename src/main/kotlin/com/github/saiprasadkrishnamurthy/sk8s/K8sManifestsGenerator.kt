...
class K8sManifestsGenerator {
    ...
    private fun loadProps(generateK8sManifestsRequest: GenerateK8sManifestsRequest, propsContext: PropertiesContext) {
        ...
        propsContext.props.forEach {
            ...
            val variableNamesInValues = extractVariableNames(baseValue)
    ...
    private fun extractVariableNames(value: String): Set<String> {
        val matchPattern = REGEX_EXTRACT_VARIABLE_NAMES_FROM_TEMPLATE.matcher(value)
